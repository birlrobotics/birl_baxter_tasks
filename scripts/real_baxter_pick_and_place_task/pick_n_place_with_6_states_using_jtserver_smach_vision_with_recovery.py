...
class GetPickPoseFromVisionModule(smach.State):
    def __init__(self):
    ...
    def execute(self, userdata):
        write_exec_hist(self, "GetPickPoseFromVisionModule", userdata, True)        
...
class Go_to_Pick_Position(smach.State):
    ...
    def execute(self, userdata):
        ...
        global pick_pose_from_vision_module
        print "pick_pose_from_vision_module:", pick_pose_from_vision_module
        ...
        pick_object_pose = pick_pose_from_vision_module
...
def main():
    ...
    with sm:
        ...
        smach.StateMachine.add(
            ...
            transitions={
                'NeedRecovery': 'Recovery',
                'Succeed':'GetPickPoseFromVisionModule'
            }
        )

        smach.StateMachine.add(
            'GetPickPoseFromVisionModule',
            GetPickPoseFromVisionModule(),
            transitions={
                'NeedRecovery': 'Recovery',
